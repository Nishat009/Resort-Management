<div class=" navbar animate-navbar" style=" background-color: mintcream;">
  <header class="d-flex   justify-content-between py-3  ">
    <a href="/" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
      <svg class="bi me-2" width="100" height="10" role="img" aria-label="Bootstrap">
        <use xlink:href="#bootstrap" />
      </svg>
    </a>

    <h1 class="  logo-words navbar-brand ms-end">
    ...
    <ul class="nav col-12 col-md-auto mb-2 justify-content-between mb-md-0">
      ...
      <li>
        @auth()
      <li class="nav-item">
        <a class="nav-link active px-3 text-dark" href="{{route('userProfile')}}" aria-current="page">My Profile</a>
      </li>
      <li>
